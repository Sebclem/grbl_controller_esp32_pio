...
#define MY_SSID "SFR_3E08"       // replace by the name of your access point (when act as station) or the name you assign to your device (when act as acces point)
...
#define MY_PASSWORD "box_clement" // replace by your password 
...
#define SUBNET ""    // subnet mask of your local network
#define GATEWAY ""     // gateway that have to check the IP address
...
#define BUTTON_BORDER_NOT_PRESSED TFT_GREEN
#define BUTTON_BORDER_PRESSED TFT_RED
